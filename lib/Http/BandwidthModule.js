    ...
    _end()
    {
        ...
        // The request ended to early, restart it with an increased data size.
            ...
            if ((this._loadingType) === 'download') {
                ...
                var nextIndex;
                if (thisIndex < this._downloadSizes.length) {
                    nextIndex = thisIndex + (dataSettings.multiplier - 1);
                } else {
                    // decrease delay because we have a finite image size
                    delay = delay / dataSettings.multiplier;
                    nextIndex = thisIndex;
                }
            ...
            this.settings({delay: delay, data: {size}});
